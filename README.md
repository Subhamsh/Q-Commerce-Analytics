...
Dataset Overview
	Source: https://www.kaggle.com/datasets/shubhampatil75/india-q-commerce-orders-dataset-2015-2025
	Year Used Initially: 2015
	Number of Columns: 34
    The dataset was synthetically generated and may not represent actual production data from any Quick Commerce company.
Key Fields:
•	Order ID 
•	City 
•	Category 
